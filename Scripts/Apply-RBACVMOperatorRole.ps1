...
.DESCRIPTION
   PowerShell script will grant role to users or groups at Subscription/ResourceGroup/VirtualMachine Level
.EXAMPLE
   Add-VMRBAC -csvLocation "C:\Users\Gurpreet.sambhi\Documents\AzureVM.csv" -role "Virtual Machine Operator" -Scope "VirtualMachine" -UserNames "gurpreet,aman" -GroupNames "abac" 
.EXAMPLE
   Add-VMRBAC -csvLocation "C:\Users\Gurpreet.sambhi\Documents\AzureVM.csv" -role "Virtual Machine Operator" -Scope "ResourceGroup" -UserNames "gurpreet,aman" -GroupNames "abac" 
.INPUTS
